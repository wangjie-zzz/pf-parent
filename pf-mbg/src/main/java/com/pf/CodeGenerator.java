...
//        MODULE_NAME = "pf"; // test
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "\\pf-mbg";
...
//        dsc.setPassword("test123");
        ...
        */
        ...
        strategy.setInclude(TABLES_NAME.stream().collect(Collectors.joining(",")));
        strategy.setControllerMappingHyphenStyle(true);
        strategy.setTablePrefix(pc.getModuleName() + "_");*/
        strategy.setInclude(TABLES_NAME.stream().toArray(String[]::new));
