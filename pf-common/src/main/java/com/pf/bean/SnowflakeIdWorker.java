...
public class SnowflakeIdWorker {
    ...
    public final static Long[] SYSTEM_ID = new Long[]{ (long)0, (long)0};
    // 单例对象
    ...
    public static void setInstance(SnowflakeIdWorker snowflakeIdWorker) {
        SnowflakeIdWorker.INSTANCE = snowflakeIdWorker;
    }
